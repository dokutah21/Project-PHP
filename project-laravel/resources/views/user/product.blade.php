...
@section('body')
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-6">
                    <div class="product-details-gallery-area"  style="opacity: 1" data-aos="fade-up"  data-aos-delay="0">
                        <!-- Start Large Image -->
                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="product-details-content-area product-details--golden" data-aos="fade-up"  data-aos-delay="200">
                        ...
                        <div class="product-details-text">
                            <h4 class="title">{{$product->TenSP}}</h4>
                                    ...
                                    <div class="single-tab-content-item">
                                        ...
                                        <ul class="comment">
                                            ...
                                            <li class="comment-list">
                                                <div class="comment-wrapper">
                                                    <div class="comment-img">
                                                        <img src="assetss/images/user/image-1.png" alt="">
                                                    </div>
                                                ...
                                                <ul class="comment-reply">
                                                    <li class="comment-reply-list">
                                                        <div class="comment-wrapper">
                                                            <div class="comment-img">
                                                                <img src="assetss/images/user/image-2.png" alt="">
                                                            </div>
                                                            <div class="comment-content">
                                                                <div class="comment-content-top">
                                                                    <div class="comment-content-left">
                                            ...
                                            <li class="comment-list">
                                                <div class="comment-wrapper">
                                                    <div class="comment-img">
                                                        <img src="assetss/images/user/image-3.png" alt="">
                                                    </div>
                                                    <div class="comment-content">
                                                        <div class="comment-content-top">
                                                            <div class="comment-content-left">
                            ...
                            <div class="swiper-container product-default-slider-4grid-1row">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        <div class="image-box">
                                            <a href="product-details-default.html" class="image-link">
                                                <img src="assetss/images/product/default/home-1/default-9.jpg" alt="">
                                                <img src="assetss/images/product/default/home-1/default-10.jpg" alt="">
                                            </a>
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        <div class="image-box">
                                            <a href="product-details-default.html" class="image-link">
                                                <img src="assetss/images/product/default/home-1/default-11.jpg" alt="">
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        <div class="image-box">
                                            <a href="product-details-default.html" class="image-link">
                                                ...
                                                <img src="assetss/images/product/default/home-1/default-7.jpg" alt="">
                                            </a>
                                            <div class="action-link">
                                                <div class="action-link-left">
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modalAddcart">Add to Cart</a>
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        <div class="image-box">
                                            <a href="product-details-default.html" class="image-link">
                                                <img src="assetss/images/product/default/home-1/default-7.jpg" alt="">
                                                <img src="assetss/images/product/default/home-1/default-8.jpg" alt="">
                                            </a>
                                            <div class="action-link">
                                                <div class="action-link-left">
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modalAddcart">Add to Cart</a>
    ...
    <script src="assetss/js/vendor/vendor.min.js"></script>
    <script src="assetss/js/plugins/plugins.min.js"></script> 
